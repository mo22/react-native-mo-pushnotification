...
export class PushNotification {
     ...
     */
    static onShowNotification = () => true;
    /**
     ...
     */
    static onFetchData = () => true;
    static verbose = false;
    static currentToken;
    static androidKnownNotifications = {};
    /**
     * be verbose
     */
     ...
     */
    static async iosSetBadge(value) {
        if (ios.Module) {
    ...
    static setupEventsDone = false;
    static setupEvents() {
        if (this.setupEventsDone)
            return;
